...
# Nuruzzaman <nur@fnal.gov>, Date Created: 06/08/2017
# 
#################################################################
LAST_MODIFIED="06/08/2017"

set -P
export User_release_area="/minerva/app/users/$USER/cmtuser"

SOFTWARE_VERSION="v10r8p9"
SYS_PACAKAGE="v10r8p9_minerva101_2017"
SYS_PACAKAGE_FOLDER="Minerva_v10r8p9_minerva101_2017"
...
if [ ! -d "/SystematicsActivity2017" ]; then
   echo "Copying the template files"

   echo scp -r /minerva/data/users/Minerva101/SystematicsActivity2017/ .
   scp -r /minerva/data/users/Minerva101/SystematicsActivity2017/ .
...
solution() {
   echo scp /minerva/data/users/Minerva101/SystematicsActivity2017Final/Systematics_Solution*.cxx $User_release_area/$SYS_PACAKAGE_FOLDER/SystematicsActivity2017
   scp /minerva/data/users/Minerva101/SystematicsActivity2017Final/Systematics_Solution*.cxx $User_release_area/$SYS_PACAKAGE_FOLDER/SystematicsActivity2017
   echo -e "Solutions are copied now."
}

final() {
   echo scp /minerva/data/users/Minerva101/SystematicsActivity2017Final/* $User_release_area/$SYS_PACAKAGE_FOLDER/SystematicsActivity2017/
   scp /minerva/data/users/Minerva101/SystematicsActivity2017Final/* $User_release_area/$SYS_PACAKAGE_FOLDER/SystematicsActivity2017/*
